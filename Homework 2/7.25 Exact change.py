...
# I don't know why I'm getting an error for an input of 300 in Zybooks
# When I run my code in Pycharm, there's no error
...
def exact_change(user_total):
    ...
    return num_pennies, num_nickles, num_dimes, num_quarters, num_dollars
